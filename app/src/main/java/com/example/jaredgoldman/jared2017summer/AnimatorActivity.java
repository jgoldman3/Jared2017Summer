...
public class AnimatorActivity extends BaseActivity {
    ...
    public void scale() {
        ObjectAnimator animator =
                ObjectAnimator.ofFloat(tv,"scaleX",0,3,1,2,5,1);
    ...
    private ValueAnimator doAnimatorListener() {
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                shortToast("Started");
                UtilLog.d(" ","animation start");
            }

            @Override
            public void onAnimationEnd(Animator animation) {
                shortToast("Ended");
                UtilLog.d(" ","animation end ");
            }

            @Override
            public void onAnimationCancel(Animator animation) {
                shortToast("Cancelled");
                UtilLog.d(" ","animation cancel");
            }

            @Override
            public void onAnimationRepeat(Animator animation) {
                shortToast("Repeated");
                UtilLog.d(" ","animation repeat");
            }
        });
    ...
    private class CharEvaluator implements TypeEvaluator<Character> {
        ...
        public Character evaluate(float fraction, Character startValue, Character endValue) {
            ...
            int curInt = (int)(startValue + fraction*(endInt-startInt));
